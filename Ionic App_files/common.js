...
/***/ "./src/app/services/referencias.service.ts":
/*!*************************************************!*\
  !*** ./src/app/services/referencias.service.ts ***!
  \*************************************************/
/*! exports provided: ReferenciasService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ReferenciasService", function() { return ReferenciasService; });
...
let ReferenciasService = class ReferenciasService {
    constructor(db) {
        this.db = db;
    }
    setCollections(idUsuario) {
        this.referenciasCollection = this.db.collection(`users/${idUsuario}/referencias`);
        this.referencias = this.referenciasCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((actions) => {
    ...
    getReferencia(id) {
        return this.referenciasCollection.doc(id).valueChanges();
    }
    updateReferencia(referencia, id) {
...
ReferenciasService.ctorParameters = () => [
    { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] }
];
ReferenciasService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
